...
//     return (
//         <div className="w-screen max-w-7xl mx-auto p-12 bg-gray-800 rounded-lg shadow-lg mt-6">
...
import React, { useState } from "react";
import { CreatePackage } from "../../services/https/package"; // Adjust the path as necessary
...
const CreatepackageForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <label>
        Duration (days):
        <input type="text" name="Duration_days" value={formData.Duration_days} onChange={handleChange} />
      </label>
